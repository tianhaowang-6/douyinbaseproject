...
type UserResponse struct {
	BaseReponse *BaseResponse `thrift:"baseReponse,1" frugal:"1,default,BaseResponse" json:"base_reponse"`
...
var UserResponse_BaseReponse_DEFAULT *BaseResponse

func (p *UserResponse) GetBaseReponse() (v *BaseResponse) {
	if !p.IsSetBaseReponse() {
		return UserResponse_BaseReponse_DEFAULT
	}
	return p.BaseReponse
}
...
func (p *UserResponse) SetBaseReponse(val *BaseResponse) {
	p.BaseReponse = val
}
...
func (p *UserResponse) IsSetBaseReponse() bool {
	return p.BaseReponse != nil
}
...
func (p *UserResponse) ReadField1(iprot thrift.TProtocol) error {
	p.BaseReponse = NewBaseResponse()
	if err := p.BaseReponse.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *UserResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("baseReponse", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.BaseReponse.Write(oprot); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *UserResponse) DeepEqual(ano *UserResponse) bool {
	...
	if !p.Field1DeepEqual(ano.BaseReponse) {
		return false
	}
...
func (p *UserResponse) Field1DeepEqual(src *BaseResponse) bool {
	...
	if !p.BaseReponse.DeepEqual(src) {
		return false
	}
	return true
}

...
type DouyinUserResponse struct {
	StatusCode int32     `thrift:"statusCode,1" frugal:"1,default,i32" json:"statusCode"`
	StatusMsg  *string   `thrift:"statusMsg,2,optional" frugal:"2,optional,string" json:"statusMsg,omitempty"`
	User       *UserInfo `thrift:"user,3" frugal:"3,default,UserInfo" json:"user"`
}
...
func (p *UserServiceClient) CheckUserInfo(ctx context.Context, req *DouyinUserRequest) (r *DouyinUserResponse, err error) {
	var _args UserServiceCheckUserInfoArgs
	_args.Req = req
	var _result UserServiceCheckUserInfoResult
...
func NewUserServiceProcessor(handler UserService) *UserServiceProcessor {
	...
	self.AddToProcessorMap("GetUserInfo", &userServiceProcessorCheckUserInfo{handler: handler})
	return self
}
...
type userServiceProcessorCheckUserInfo struct {
	handler UserService
}

func (p *userServiceProcessorCheckUserInfo) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := UserServiceCheckUserInfoArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := UserServiceCheckUserInfoResult{}
...
type UserServiceCheckUserInfoArgs struct {
	Req *DouyinUserRequest `thrift:"req,1" frugal:"1,default,DouyinUserRequest" json:"req"`
}

func NewUserServiceCheckUserInfoArgs() *UserServiceCheckUserInfoArgs {
	return &UserServiceCheckUserInfoArgs{}
}

func (p *UserServiceCheckUserInfoArgs) InitDefault() {
	*p = UserServiceCheckUserInfoArgs{}
}

var UserServiceCheckUserInfoArgs_Req_DEFAULT *DouyinUserRequest

func (p *UserServiceCheckUserInfoArgs) GetReq() (v *DouyinUserRequest) {
	if !p.IsSetReq() {
		return UserServiceCheckUserInfoArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *UserServiceCheckUserInfoArgs) SetReq(val *DouyinUserRequest) {
	p.Req = val
}

var fieldIDToName_UserServiceCheckUserInfoArgs = map[int16]string{
	1: "req",
}

func (p *UserServiceCheckUserInfoArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *UserServiceCheckUserInfoArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceCheckUserInfoArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *UserServiceCheckUserInfoArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *UserServiceCheckUserInfoArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("CheckUserInfo_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *UserServiceCheckUserInfoArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *UserServiceCheckUserInfoArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UserServiceCheckUserInfoArgs(%+v)", *p)
}

func (p *UserServiceCheckUserInfoArgs) DeepEqual(ano *UserServiceCheckUserInfoArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *UserServiceCheckUserInfoArgs) Field1DeepEqual(src *DouyinUserRequest) bool {
...
type UserServiceCheckUserInfoResult struct {
	Success *DouyinUserResponse `thrift:"success,0,optional" frugal:"0,optional,DouyinUserResponse" json:"success,omitempty"`
}

func NewUserServiceCheckUserInfoResult() *UserServiceCheckUserInfoResult {
	return &UserServiceCheckUserInfoResult{}
}

func (p *UserServiceCheckUserInfoResult) InitDefault() {
	*p = UserServiceCheckUserInfoResult{}
}

var UserServiceCheckUserInfoResult_Success_DEFAULT *DouyinUserResponse

func (p *UserServiceCheckUserInfoResult) GetSuccess() (v *DouyinUserResponse) {
	if !p.IsSetSuccess() {
		return UserServiceCheckUserInfoResult_Success_DEFAULT
	}
	return p.Success
}
func (p *UserServiceCheckUserInfoResult) SetSuccess(x interface{}) {
	p.Success = x.(*DouyinUserResponse)
}

var fieldIDToName_UserServiceCheckUserInfoResult = map[int16]string{
	0: "success",
}

func (p *UserServiceCheckUserInfoResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *UserServiceCheckUserInfoResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceCheckUserInfoResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *UserServiceCheckUserInfoResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *UserServiceCheckUserInfoResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("CheckUserInfo_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *UserServiceCheckUserInfoResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *UserServiceCheckUserInfoResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UserServiceCheckUserInfoResult(%+v)", *p)
}

func (p *UserServiceCheckUserInfoResult) DeepEqual(ano *UserServiceCheckUserInfoResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *UserServiceCheckUserInfoResult) Field0DeepEqual(src *DouyinUserResponse) bool {

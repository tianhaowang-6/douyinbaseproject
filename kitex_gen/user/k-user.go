...
func (p *UserResponse) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "baseReponse", thrift.STRUCT, 1)
	offset += p.BaseReponse.FastWriteNocopy(buf[offset:], binaryWriter)
	offset += bthrift.Binary.WriteFieldEnd(buf[offset:])
	return offset
}
...
func (p *UserResponse) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("baseReponse", thrift.STRUCT, 1)
	l += p.BaseReponse.BLength()
	l += bthrift.Binary.FieldEndLength()
	return l
}

...
type Client interface {
	...
	RelationActionMessage(ctx context.Context, req *message.RelationActionMessageRequest, callOptions ...callopt.Option) (r *message.RelationActionMessageResponse, err error)
}
...
func (p *kMessageServiceClient) RelationActionMessage(ctx context.Context, req *message.RelationActionMessageRequest, callOptions ...callopt.Option) (r *message.RelationActionMessageResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.RelationActionMessage(ctx, req)
}

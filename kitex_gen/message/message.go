...
type RelationActionMessageRequest struct {
	Token      string `thrift:"token,1" frugal:"1,default,string" json:"token"`
	ToUserId   int64  `thrift:"toUserId,2" frugal:"2,default,i64" json:"to_user_id"`
...
func NewRelationActionMessageRequest() *RelationActionMessageRequest {
	return &RelationActionMessageRequest{}
}

func (p *RelationActionMessageRequest) InitDefault() {
	*p = RelationActionMessageRequest{}
}

func (p *RelationActionMessageRequest) GetToken() (v string) {
	return p.Token
}

func (p *RelationActionMessageRequest) GetToUserId() (v int64) {
	return p.ToUserId
}

func (p *RelationActionMessageRequest) GetActionType() (v int32) {
	return p.ActionType
}

func (p *RelationActionMessageRequest) GetContent() (v string) {
	return p.Content
}
func (p *RelationActionMessageRequest) SetToken(val string) {
	p.Token = val
}
func (p *RelationActionMessageRequest) SetToUserId(val int64) {
	p.ToUserId = val
}
func (p *RelationActionMessageRequest) SetActionType(val int32) {
	p.ActionType = val
}
func (p *RelationActionMessageRequest) SetContent(val string) {
	p.Content = val
}

var fieldIDToName_RelationActionMessageRequest = map[int16]string{
	1: "token",
	2: "toUserId",
	3: "actionType",
	4: "content",
...
func (p *RelationActionMessageRequest) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RelationActionMessageRequest[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *RelationActionMessageRequest) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.Token = v
...
func (p *RelationActionMessageRequest) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI64(); err != nil {
		return err
	} else {
		p.ToUserId = v
...
func (p *RelationActionMessageRequest) ReadField3(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI32(); err != nil {
		return err
	} else {
		p.ActionType = v
...
func (p *RelationActionMessageRequest) ReadField4(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.Content = v
...
func (p *RelationActionMessageRequest) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("RelationActionMessageRequest"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *RelationActionMessageRequest) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("token", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Token); err != nil {
...
func (p *RelationActionMessageRequest) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("toUserId", thrift.I64, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI64(p.ToUserId); err != nil {
...
func (p *RelationActionMessageRequest) writeField3(oprot thrift.TProtocol) (err error) {
...
func (p *RelationActionMessageRequest) writeField4(oprot thrift.TProtocol) (err error) {
...
func (p *RelationActionMessageRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("RelationActionMessageRequest(%+v)", *p)
}

func (p *RelationActionMessageRequest) DeepEqual(ano *RelationActionMessageRequest) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *RelationActionMessageRequest) Field1DeepEqual(src string) bool {
...
func (p *RelationActionMessageRequest) Field2DeepEqual(src int64) bool {
...
func (p *RelationActionMessageRequest) Field3DeepEqual(src int32) bool {
...
func (p *RelationActionMessageRequest) Field4DeepEqual(src string) bool {
...
type RelationActionMessageResponse struct {
	StatusCode int32   `thrift:"statusCode,1" frugal:"1,default,i32" json:"status_code"`
	StatusMsg  *string `thrift:"statusMsg,2,optional" frugal:"2,optional,string" json:"status_msg"`
}

func NewRelationActionMessageResponse() *RelationActionMessageResponse {
	return &RelationActionMessageResponse{}
}

func (p *RelationActionMessageResponse) InitDefault() {
	*p = RelationActionMessageResponse{}
}

func (p *RelationActionMessageResponse) GetStatusCode() (v int32) {
	return p.StatusCode
}

var RelationActionMessageResponse_StatusMsg_DEFAULT string

func (p *RelationActionMessageResponse) GetStatusMsg() (v string) {
	if !p.IsSetStatusMsg() {
		return RelationActionMessageResponse_StatusMsg_DEFAULT
	}
	return *p.StatusMsg
}
func (p *RelationActionMessageResponse) SetStatusCode(val int32) {
	p.StatusCode = val
}
func (p *RelationActionMessageResponse) SetStatusMsg(val *string) {
	p.StatusMsg = val
}

var fieldIDToName_RelationActionMessageResponse = map[int16]string{
	1: "statusCode",
	2: "statusMsg",
}

func (p *RelationActionMessageResponse) IsSetStatusMsg() bool {
	return p.StatusMsg != nil
}

func (p *RelationActionMessageResponse) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_RelationActionMessageResponse[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *RelationActionMessageResponse) ReadField1(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI32(); err != nil {
		return err
	} else {
		p.StatusCode = v
...
func (p *RelationActionMessageResponse) ReadField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return err
	} else {
		p.StatusMsg = &v
...
func (p *RelationActionMessageResponse) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("RelationActionMessageResponse"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *RelationActionMessageResponse) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("statusCode", thrift.I32, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI32(p.StatusCode); err != nil {
...
func (p *RelationActionMessageResponse) writeField2(oprot thrift.TProtocol) (err error) {
	if p.IsSetStatusMsg() {
		if err = oprot.WriteFieldBegin("statusMsg", thrift.STRING, 2); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *RelationActionMessageResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("RelationActionMessageResponse(%+v)", *p)
}

func (p *RelationActionMessageResponse) DeepEqual(ano *RelationActionMessageResponse) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *RelationActionMessageResponse) Field1DeepEqual(src int32) bool {
...
func (p *RelationActionMessageResponse) Field2DeepEqual(src *string) bool {
...
type MessageService interface {
	...
	RelationActionMessage(ctx context.Context, req *RelationActionMessageRequest) (r *RelationActionMessageResponse, err error)
}
...
func (p *MessageServiceClient) RelationActionMessage(ctx context.Context, req *RelationActionMessageRequest) (r *RelationActionMessageResponse, err error) {
	var _args MessageServiceRelationActionMessageArgs
	_args.Req = req
	var _result MessageServiceRelationActionMessageResult
	if err = p.Client_().Call(ctx, "RelationActionMessage", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewMessageServiceProcessor(handler MessageService) *MessageServiceProcessor {
	...
	self.AddToProcessorMap("RelationActionMessage", &messageServiceProcessorRelationActionMessage{handler: handler})
	return self
}
...
type messageServiceProcessorRelationActionMessage struct {
	handler MessageService
}

func (p *messageServiceProcessorRelationActionMessage) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := MessageServiceRelationActionMessageArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("RelationActionMessage", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := MessageServiceRelationActionMessageResult{}
	var retval *RelationActionMessageResponse
	if retval, err2 = p.handler.RelationActionMessage(ctx, args.Req); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing RelationActionMessage: "+err2.Error())
		oprot.WriteMessageBegin("RelationActionMessage", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("RelationActionMessage", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type MessageServiceRelationActionMessageArgs struct {
	Req *RelationActionMessageRequest `thrift:"req,1" frugal:"1,default,RelationActionMessageRequest" json:"req"`
}

func NewMessageServiceRelationActionMessageArgs() *MessageServiceRelationActionMessageArgs {
	return &MessageServiceRelationActionMessageArgs{}
}

func (p *MessageServiceRelationActionMessageArgs) InitDefault() {
	*p = MessageServiceRelationActionMessageArgs{}
}

var MessageServiceRelationActionMessageArgs_Req_DEFAULT *RelationActionMessageRequest

func (p *MessageServiceRelationActionMessageArgs) GetReq() (v *RelationActionMessageRequest) {
	if !p.IsSetReq() {
		return MessageServiceRelationActionMessageArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *MessageServiceRelationActionMessageArgs) SetReq(val *RelationActionMessageRequest) {
	p.Req = val
}

var fieldIDToName_MessageServiceRelationActionMessageArgs = map[int16]string{
	1: "req",
}

func (p *MessageServiceRelationActionMessageArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *MessageServiceRelationActionMessageArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MessageServiceRelationActionMessageArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *MessageServiceRelationActionMessageArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewRelationActionMessageRequest()
	if err := p.Req.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *MessageServiceRelationActionMessageArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("RelationActionMessage_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *MessageServiceRelationActionMessageArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *MessageServiceRelationActionMessageArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("MessageServiceRelationActionMessageArgs(%+v)", *p)
}

func (p *MessageServiceRelationActionMessageArgs) DeepEqual(ano *MessageServiceRelationActionMessageArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *MessageServiceRelationActionMessageArgs) Field1DeepEqual(src *RelationActionMessageRequest) bool {
...
type MessageServiceRelationActionMessageResult struct {
	Success *RelationActionMessageResponse `thrift:"success,0,optional" frugal:"0,optional,RelationActionMessageResponse" json:"success,omitempty"`
}

func NewMessageServiceRelationActionMessageResult() *MessageServiceRelationActionMessageResult {
	return &MessageServiceRelationActionMessageResult{}
}

func (p *MessageServiceRelationActionMessageResult) InitDefault() {
	*p = MessageServiceRelationActionMessageResult{}
}

var MessageServiceRelationActionMessageResult_Success_DEFAULT *RelationActionMessageResponse

func (p *MessageServiceRelationActionMessageResult) GetSuccess() (v *RelationActionMessageResponse) {
	if !p.IsSetSuccess() {
		return MessageServiceRelationActionMessageResult_Success_DEFAULT
	}
	return p.Success
}
func (p *MessageServiceRelationActionMessageResult) SetSuccess(x interface{}) {
	p.Success = x.(*RelationActionMessageResponse)
}

var fieldIDToName_MessageServiceRelationActionMessageResult = map[int16]string{
	0: "success",
}

func (p *MessageServiceRelationActionMessageResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *MessageServiceRelationActionMessageResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_MessageServiceRelationActionMessageResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *MessageServiceRelationActionMessageResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewRelationActionMessageResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *MessageServiceRelationActionMessageResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("RelationActionMessage_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *MessageServiceRelationActionMessageResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *MessageServiceRelationActionMessageResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("MessageServiceRelationActionMessageResult(%+v)", *p)
}

func (p *MessageServiceRelationActionMessageResult) DeepEqual(ano *MessageServiceRelationActionMessageResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *MessageServiceRelationActionMessageResult) Field0DeepEqual(src *RelationActionMessageResponse) bool {

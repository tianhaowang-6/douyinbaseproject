...
type FeedRequest struct {
	LatestTime *int64  `thrift:"latestTime,1,optional" frugal:"1,optional,i64" json:""`
...
func (p *FeedServiceClient) FavoriteAction(ctx context.Context, req *FavoriteActionRequest) (r *FavoriteActionResponse, err error) {
	var _args FeedServiceFavoriteActionArgs
	_args.Req = req
	var _result FeedServiceFavoriteActionResult
	if err = p.Client_().Call(ctx, "FavoriteAction", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *FeedServiceClient) FavoriteList(ctx context.Context, req *FavoriteListRequest) (r *FavoriteListResponse, err error) {
	var _args FeedServiceFavoriteListArgs
	_args.Req = req
	var _result FeedServiceFavoriteListResult
...
func NewFeedServiceProcessor(handler FeedService) *FeedServiceProcessor {
	...
	self.AddToProcessorMap("FavoriteAction", &feedServiceProcessorFavoriteAction{handler: handler})
	self.AddToProcessorMap("FavoriteList", &feedServiceProcessorFavoriteList{handler: handler})
	return self
}
...
type feedServiceProcessorFavoriteAction struct {
	handler FeedService
}

func (p *feedServiceProcessorFavoriteAction) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := FeedServiceFavoriteActionArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := FeedServiceFavoriteActionResult{}
...
type feedServiceProcessorFavoriteList struct {
	handler FeedService
}

func (p *feedServiceProcessorFavoriteList) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := FeedServiceFavoriteListArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := FeedServiceFavoriteListResult{}
...
type FeedServiceFavoriteActionArgs struct {
	Req *FavoriteActionRequest `thrift:"req,1" frugal:"1,default,FavoriteActionRequest" json:"req"`
}

func NewFeedServiceFavoriteActionArgs() *FeedServiceFavoriteActionArgs {
	return &FeedServiceFavoriteActionArgs{}
}

func (p *FeedServiceFavoriteActionArgs) InitDefault() {
	*p = FeedServiceFavoriteActionArgs{}
}

var FeedServiceFavoriteActionArgs_Req_DEFAULT *FavoriteActionRequest

func (p *FeedServiceFavoriteActionArgs) GetReq() (v *FavoriteActionRequest) {
	if !p.IsSetReq() {
		return FeedServiceFavoriteActionArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *FeedServiceFavoriteActionArgs) SetReq(val *FavoriteActionRequest) {
	p.Req = val
}

var fieldIDToName_FeedServiceFavoriteActionArgs = map[int16]string{
	1: "req",
}

func (p *FeedServiceFavoriteActionArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *FeedServiceFavoriteActionArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FeedServiceFavoriteActionArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *FeedServiceFavoriteActionArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *FeedServiceFavoriteActionArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *FeedServiceFavoriteActionArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *FeedServiceFavoriteActionArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("FeedServiceFavoriteActionArgs(%+v)", *p)
}

func (p *FeedServiceFavoriteActionArgs) DeepEqual(ano *FeedServiceFavoriteActionArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *FeedServiceFavoriteActionArgs) Field1DeepEqual(src *FavoriteActionRequest) bool {
...
type FeedServiceFavoriteActionResult struct {
	Success *FavoriteActionResponse `thrift:"success,0,optional" frugal:"0,optional,FavoriteActionResponse" json:"success,omitempty"`
}

func NewFeedServiceFavoriteActionResult() *FeedServiceFavoriteActionResult {
	return &FeedServiceFavoriteActionResult{}
}

func (p *FeedServiceFavoriteActionResult) InitDefault() {
	*p = FeedServiceFavoriteActionResult{}
}

var FeedServiceFavoriteActionResult_Success_DEFAULT *FavoriteActionResponse

func (p *FeedServiceFavoriteActionResult) GetSuccess() (v *FavoriteActionResponse) {
	if !p.IsSetSuccess() {
		return FeedServiceFavoriteActionResult_Success_DEFAULT
	}
	return p.Success
}
func (p *FeedServiceFavoriteActionResult) SetSuccess(x interface{}) {
	p.Success = x.(*FavoriteActionResponse)
}

var fieldIDToName_FeedServiceFavoriteActionResult = map[int16]string{
	0: "success",
}

func (p *FeedServiceFavoriteActionResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *FeedServiceFavoriteActionResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FeedServiceFavoriteActionResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *FeedServiceFavoriteActionResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *FeedServiceFavoriteActionResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *FeedServiceFavoriteActionResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *FeedServiceFavoriteActionResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("FeedServiceFavoriteActionResult(%+v)", *p)
}

func (p *FeedServiceFavoriteActionResult) DeepEqual(ano *FeedServiceFavoriteActionResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *FeedServiceFavoriteActionResult) Field0DeepEqual(src *FavoriteActionResponse) bool {
...
type FeedServiceFavoriteListArgs struct {
	Req *FavoriteListRequest `thrift:"req,1" frugal:"1,default,FavoriteListRequest" json:"req"`
}

func NewFeedServiceFavoriteListArgs() *FeedServiceFavoriteListArgs {
	return &FeedServiceFavoriteListArgs{}
}

func (p *FeedServiceFavoriteListArgs) InitDefault() {
	*p = FeedServiceFavoriteListArgs{}
}

var FeedServiceFavoriteListArgs_Req_DEFAULT *FavoriteListRequest

func (p *FeedServiceFavoriteListArgs) GetReq() (v *FavoriteListRequest) {
	if !p.IsSetReq() {
		return FeedServiceFavoriteListArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *FeedServiceFavoriteListArgs) SetReq(val *FavoriteListRequest) {
	p.Req = val
}

var fieldIDToName_FeedServiceFavoriteListArgs = map[int16]string{
	1: "req",
}

func (p *FeedServiceFavoriteListArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *FeedServiceFavoriteListArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FeedServiceFavoriteListArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *FeedServiceFavoriteListArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *FeedServiceFavoriteListArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *FeedServiceFavoriteListArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *FeedServiceFavoriteListArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("FeedServiceFavoriteListArgs(%+v)", *p)
}

func (p *FeedServiceFavoriteListArgs) DeepEqual(ano *FeedServiceFavoriteListArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *FeedServiceFavoriteListArgs) Field1DeepEqual(src *FavoriteListRequest) bool {
...
type FeedServiceFavoriteListResult struct {
	Success *FavoriteListResponse `thrift:"success,0,optional" frugal:"0,optional,FavoriteListResponse" json:"success,omitempty"`
}

func NewFeedServiceFavoriteListResult() *FeedServiceFavoriteListResult {
	return &FeedServiceFavoriteListResult{}
}

func (p *FeedServiceFavoriteListResult) InitDefault() {
	*p = FeedServiceFavoriteListResult{}
}

var FeedServiceFavoriteListResult_Success_DEFAULT *FavoriteListResponse

func (p *FeedServiceFavoriteListResult) GetSuccess() (v *FavoriteListResponse) {
	if !p.IsSetSuccess() {
		return FeedServiceFavoriteListResult_Success_DEFAULT
	}
	return p.Success
}
func (p *FeedServiceFavoriteListResult) SetSuccess(x interface{}) {
	p.Success = x.(*FavoriteListResponse)
}

var fieldIDToName_FeedServiceFavoriteListResult = map[int16]string{
	0: "success",
}

func (p *FeedServiceFavoriteListResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *FeedServiceFavoriteListResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FeedServiceFavoriteListResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *FeedServiceFavoriteListResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *FeedServiceFavoriteListResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *FeedServiceFavoriteListResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *FeedServiceFavoriteListResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("FeedServiceFavoriteListResult(%+v)", *p)
}

func (p *FeedServiceFavoriteListResult) DeepEqual(ano *FeedServiceFavoriteListResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *FeedServiceFavoriteListResult) Field0DeepEqual(src *FavoriteListResponse) bool {

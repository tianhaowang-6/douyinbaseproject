...
func TestUserAction(t *testing.T) {
	...
	registerValue := fmt.Sprintf(" %d", rand.Intn(65536))

	registerResp := e.POST("/ /user/register/").
...
func TestPublish(t *testing.T) {
	...
	publishResp := e.POST("/ /publish/action/").
		WithMultipart().
	...
	publishListResp := e.GET("/ /publish/list/").

...
func TestFavorite(t *testing.T) {
	...
	feedResp := e.GET("/ /feed/").Expect().Status(http.StatusOK).JSON().Object()
	...
	favoriteResp := e.POST("/ /favorite/action/").
	...
	favoriteListResp := e.GET("/ /favorite/list/").
...
func TestComment(t *testing.T) {
	...
	addCommentResp := e.POST("/ /comment/action/").
	...
	commentListResp := e.GET("/ /comment/list/").
	...
	delCommentResp := e.POST("/ /comment/action/").

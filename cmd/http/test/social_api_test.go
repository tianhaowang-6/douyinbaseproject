...
func TestRelation(t *testing.T) {
	...
	relationResp := e.POST("/ /relation/action/").
	...
	followListResp := e.GET("/ /relation/follow/list/").
	...
	followerListResp := e.GET("/ /relation/follower/list/").
...
func TestChat(t *testing.T) {
	...
	messageResp := e.POST("/ /message/action/").
